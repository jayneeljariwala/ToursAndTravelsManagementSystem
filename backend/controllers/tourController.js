...
export const createTour = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to save the tour, please try again" });
  }
};
...
export const updateTour = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to update the tour" });
  }
};
...
export const deleteTour = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, message: "Failed to delete the tour" });
  }
};
